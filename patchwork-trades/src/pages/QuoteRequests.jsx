  ...
  useEffect(() => {
    ...
    const processPaymentCompletion = async () => {
      ...
      try {
        ...
        // STEP 2: Update quote request status to moved_to_active_jobs (hide from quote requests)
        ...
        console.log('✅ Quote request moved to active jobs and hidden from quote requests');
