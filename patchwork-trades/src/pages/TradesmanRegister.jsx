...
const TradesmanRegister = () => {
  ...
  const tradeTypes = [
    ...
    'Landscaper', 'Handyman', 'HVAC Technician', 'Flooring Specialist'
  ];
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold text-center mb-6">Register as Tradesman</h2>
...
export default TradesmanRegister;
